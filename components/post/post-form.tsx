...
export function PostForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setTimeout(() => {
        router.push(`/forum/post/${newPost.slug}`)
      }, 1500)
    } catch (err) {
       ...
       <div className="space-y-6">
         ...
         <div className="retro-panel p-6">
           ...
           <div className="space-y-2 text-sm text-slate-400">
             ...
             <p>• Para filmes/séries, use o ID do TMDB para dados automáticos</p>
         ...
         <div className="retro-panel p-6 border-l-4 border-yellow-500">
           <h3 className="text-lg font-bold text-retro-text mb-2">Lembre-se!</h3>
           <div className="space-y-2 text-sm text-slate-400">
             <p>• Siga as regras do fórum</p>
             <p>• Não poste conteúdo duplicado</p>
             <p>• Use a categoria correta</p>
             <p>• Seja respeitoso com a comunidade</p>
           </div>
         </div>
       </div>
     </div>
